        ...
        <div className="grow overflow-auto">
          ...
          <Tabs defaultValue="profile">
            ...
            <TabsContent className="mt-4 space-y-4" value="profile">
              ...
              <div className="space-y-1">
                <Label className="text-sm">
                  What would you like the Webby to know about you to provide
                  better responses?
                </Label>
                ...
                <TextareaAutosize
                  ...
                  placeholder="I learn best by observing others and seeing how they solve problems before trying it myself. (Optional)"
                  minRows={6}
                  maxRows={10}
                />
            ...
            <TabsContent className="mt-4 space-y-4" value="keys">
                      ...
                      <div className="space-y-1">
                        {envKeyMap["azure_openai_endpoint"] ? (
                          <Label className="text-xs">
                            Azure Endpoint already set by admin.
                          </Label>
                        ) : (
                          <>
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_35_turbo_name"] ? (
                          <Label className="text-xs">
                            Azure GPT-3.5 Turbo Deployment Name already set by
                            admin.
                          </Label>
                        ) : (
                          <>
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_45_turbo_name"] ? (
                          <Label className="text-xs">
                            Azure GPT-4.5 Turbo deployment name already set by
                            admin.
                          </Label>
                        ) : (
                          <>
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_45_vision_name"] ? (
                          <Label className="text-xs">
                            Azure GPT-4.5 Vision deployment name already set by
                            admin.
                          </Label>
                        ) : (
                          <>
              ...
              <div className="space-y-1">
                {envKeyMap["google"] ? (
                  <Label>Google Gemini API key already set</Label>
                ) : (
                  <>
